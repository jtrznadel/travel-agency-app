            ...
            return (
                    <div key={key} className="bg-transparent/25 w-full p-5 mb-5">
                        <div className="grid grid-cols-12 grid-rows-3 gap-0">
                            ...
                            <div className="col-span-5 col-start-5 row-start-3 font-poppins text-white"><span className='font-bold'>Place: </span>{tour.country}/{tour.destinationPoint} 
                            <span className='font-bold'><br/>Date: </span>{startDate} - {endDate}
                            <span className='font-bold'><br/>Price: $</span>{tour.price}</div>
